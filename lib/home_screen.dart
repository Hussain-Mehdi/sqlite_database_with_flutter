                    ...
                    return ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Text(message.date,style: const TextStyle(
                            fontSize: 8
                          ),),
                        ],
                      ),
                      leading: const CircleAvatar(
                        ...
                        child: Text("PJ",style: TextStyle(color: Colors.white),),
                      ),
                      trailing: SizedBox(
                         width: 100,
                        child: Row(
                          children: [
                            IconButton(onPressed: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context) => ComposeMessage(message),));
                            }, icon: const Icon(Icons.edit)),
                            IconButton(onPressed: ()async{
                            String status=   await Message.deletedMessage(message.id??0);
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                              ...
                              content: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color: const Color.fromARGB(255, 18, 76, 109), 
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: const BoxDecoration(
                                      image: DecorationImage(image: NetworkImage("https://cdn-icons-png.freepik.com/512/7518/7518748.png"))
                                    ),
                                  ), 
